...
| answerable_lockout_threshold | answerable | False | False | requirements/authentication.md | logs/test_run_2026_09_15.log, requirements/authentication.md, src/login_service.py | requirements/authentication.md | PASS |
...
| answerable_counter_reset | answerable | False | False | requirements/authentication.md | logs/test_run_2026_09_15.log, requirements/authentication.md | requirements/authentication.md | PASS |
| answerable_service_unavailable_behavior | answerable | False | False | src/login_service.py | logs/test_run_2026_09_15.log, requirements/authentication.md, src/login_service.py | src/login_service.py | PASS |
| answerable_max_failed_attempts_constant | answerable | False | False | src/login_service.py | logs/test_run_2026_09_15.log, requirements/authentication.md, src/login_service.py | src/login_service.py | PASS |
...
| answerable_cross_document_distinguish_failure_modes | answerable | False | False | requirements/authentication.md, src/login_service.py | logs/test_run_2026_09_15.log, requirements/authentication.md, src/login_service.py | requirements/authentication.md | PASS |
...
| partially_answerable_ranking_inversion | partially_answerable | False | False | requirements/authentication.md | logs/test_run_2026_09_15.log, requirements/authentication.md | logs/test_run_2026_09_15.log | PARTIAL |
...
| partially_answerable_log_fragmentation | partially_answerable | False | False | logs/test_run_2026_09_15.log | logs/test_run_2026_09_15.log | logs/test_run_2026_09_15.log | PARTIAL |
...
**A fully correct grounding would cite:** ['logs/test_run_2026_09_15.log']
...
**Observed:** not_in_corpus=False, returned source(s)=['logs/test_run_2026_09_15.log', 'requirements/authentication.md']
...
**A fully correct grounding would cite:** ['requirements/authentication.md', 'logs/test_run_2026_09_15.log', 'src/login_service.py']
...
**Observed:** not_in_corpus=False, returned source(s)=['logs/test_run_2026_09_15.log']
**A fully correct grounding would cite:** ['logs/test_run_2026_09_15.log#L4-L7', 'logs/test_run_2026_09_15.log#L12-L17', 'logs/test_run_2026_09_15.log#L19-L19']
